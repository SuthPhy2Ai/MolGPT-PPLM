# NOTE: This evaluation script requires additional dependencies:
# - guacamol: pip install guacamol
# - fcd_torch: pip install fcd_torch
# - moses: pip install git+https://github.com/molecularsets/moses.git
# Uncomment the imports below after installing these dependencies
